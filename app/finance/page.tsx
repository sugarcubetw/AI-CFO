...
export default function FinancePage() {
  ...
  const [activeTab, setActiveTab] = useState<"overview" | "add" | "income" | "query">("overview");
  ...
  return <main className={`finance-app finance-tab-${activeTab}`}>
    ...
    <section className="finance-income-dashboard"><IncomeDashboard /></section>
  </main>;
}
