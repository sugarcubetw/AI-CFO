...
export default function FinancePage() {
  ...
  function addCategory() { const value = newCategory.trim(); if (!value || categories.includes(value)) return; setCategories((current) => [...current, value]); setForm((current) => ({ ...current, category: value })); setNewCategory(""); setMessage(`已新增類別：${value}`); }
